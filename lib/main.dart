...
import 'package:expen/view/wrapperScreen/pages/wrapperScreen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (ctx) => CategoryNotifier()),
        ChangeNotifierProvider(create: (ctx) => ExpenseNotifier()),
        ChangeNotifierProvider(create: (ctx) => SubcategoryNotifier()),
        ChangeNotifierProvider(create: (ctx) => SettingsNotifier()),
        ChangeNotifierProvider(create: (ctx) => NoteNotifier()),
        ChangeNotifierProvider(create: (ctx) => NotificationNotifier()),
        ChangeNotifierProvider(create: (ctx) => SalaryNotifier()),

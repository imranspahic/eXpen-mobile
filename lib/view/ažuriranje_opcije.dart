      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(children: <Widget>[
            ListTile(
              onTap: () async {
                DatabaseHelper.updateSlikePathFix(
                    'kategorije', 'assets/images/nema-slike.jpg');
              },
              title: Text(
                'Verzija 1.0.1.',
              ...
              trailing: Padding(
                ...
                child:
                    Container(child: Icon(Icons.perm_data_setting, size: 35)),
              ),
            ),
            ListTile(
              onTap: () async {
            ...
            ListTile(
              onTap: () async {
                DatabaseHelper.dodajColumnMjesecnoDodavanjePotkategorije(
                    'potkategorije');
              },
              title: Text(
                'Verzija 1.0.7.',
              ...
              subtitle: Text(
                  'Dodaj tabelu mjesečno dodavanje u potkategorije tabelu!'),
              trailing: Padding(
                padding: const EdgeInsets.only(right: 8.0),
                child:
                    Container(child: Icon(Icons.perm_data_setting, size: 35)),
            ...
            ListTile(
              onTap: () async {
                DatabaseHelper.updateCategoryTableIconColor();
              },
              title: Text(
                'Verzija 1.0.9.',
                style: TextStyle(fontSize: 22),
              ),
              subtitle: Text('Ažuriranje tabele kategorije'),
              trailing: Padding(
                padding: const EdgeInsets.only(right: 8.0),
                child:
                    Container(child: Icon(Icons.perm_data_setting, size: 35)),
